...
IMPRIMIR NO DISPLAY USANDO DMD2
    Serial.println("V-35-150-DMD2-VARREDURA-SERIAL1:");
...
*/
 ...
 DMD_TextBox box(dmd, 0, 1); // BOX PRIMEIRA IMPRESSAO
 DMD_TextBox box1(dmd, 64, 2); // BOX SEGUNDA IMPRESSAO
 //################# DISPLAY //
 //################# TRATAMENTO MENSAGEM //
