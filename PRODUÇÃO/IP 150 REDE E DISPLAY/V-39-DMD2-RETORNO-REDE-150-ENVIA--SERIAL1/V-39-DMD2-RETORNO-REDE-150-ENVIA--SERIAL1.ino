...
IMPRIMIR NO DISPLAY USANDO DMD2
    Serial.println("V-35-DMD2-RETORNO-REDE-151-ENVIA--SERIAL1:");
...
*/
 ...
 void setup() {
     ...
     Serial.println("V-39-DMD2-RETORNO-REDE-150-ENVIA--SERIAL1:");
     Serial.println("IP:");
